...
function Sidebar(loopy){
	...
	(function(){
		...
		page.addComponent(new ComponentHTML({
			...
			"Load your custom diagram to CLD-Explorer" + 
			"with <span class='mini_button' onclick='publish(\"modal\",[\"save_link\"])'>save as link</span>, " + 
			"and paste it in the bar below LOOPY."+
